  ...
  for (const r of RAW) {
    ...
    built.push({
      ...
      impact: reached >= STAGE_INDEX.impact_measured
        ...
        : null,
      prototypeData: reached >= STAGE_INDEX.prototype ? {
        title: `${category} Working Prototype & Field Demo`,
        abstract: `Lab-tested working prototype addressing ${r.title.toLowerCase()}. Built with modular components, low operating costs, and automated sensor logging.`,
        trl: reached >= STAGE_INDEX.deployment ? 8 : reached >= STAGE_INDEX.pilot ? 7 : reached >= STAGE_INDEX.testing ? 6 : 5,
        estimatedFunding: r.affected > 5000 ? 2400000 : 1250000,
        fundingRaised: reached >= STAGE_INDEX.industry_matched ? (r.affected > 5000 ? 2400000 : 1250000) : 0,
        demoUrl: `https://demo.samadhansetu.gov.in/prototypes/${r.id.toLowerCase()}`,
        videoDemoUrl: 'https://www.youtube.com/watch?v=sample-prototype',
        integrationRequirements: [
          '3-Phase 415V power or 3kW dedicated solar hybrid microgrid installation',
          'GSM / 4G cellular IoT telemetry for cloud dashboard monitoring',
          'District Administration NOC & local Gram Panchayat site clearance',
          '3-day community operator and technician capacity building program',
        ],
        facultyLead: `Prof. Innovation Lead (${uni?.short || 'University'})`,
        studentContributors: ['Aakash Tirkey (B.Tech)', 'Priya Mahto (M.Tech)', 'Rohit Soren (Research Scholar)'],
